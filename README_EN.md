...
Mac Gaming Toolbox is a native SwiftUI macOS app that brings common Mac gaming utilities together in one place. Version 3.0.6 supports both Chinese and English interfaces and is compatible with Intel and Apple Silicon Macs.
...
./Scripts/sign-and-notarize.sh '/path/to/Mac 游戏工具箱.app' 'MacGameToolbox-3.0.6.dmg'
```
